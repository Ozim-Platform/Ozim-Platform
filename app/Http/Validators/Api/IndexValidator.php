...
class IndexValidator extends CustomValidator
{
    use ValidatorTrait;
    ...
    static public function init(string $request_type = null,array $validation_fields = []){
        ...
        switch ($request_type){
            ...
            case "model":
                return self::model($validation_fields);
    ...
    static function index($validation_fields){
        ...
        ], self::getMessagesValidatorFromFile('api.index'));
     ...
     * @return \Illuminate\Contracts\Validation\Validator
     */
    static function model($validation_fields){
