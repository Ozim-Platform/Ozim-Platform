...
class ServiceProviderController extends Controller
{
    ...
    public function index(){
        $namespace_create = 'admin.service_provider.create';
    ...
    public function create(){
        $namespace_index = 'admin.service_provider.index';
        $namespace_store = 'admin.service_provider.store';
        $languages = Language::all();
        $categories = Category::where('type', 'service_provider')->get();
    ...
    public function store(Request $request){
        ...
        $model->image = $request->has('image')
            ? MediaHelper::uploadFile($request->image, 'service_providers') : $model->image;
    ...
    public function edit($id){
        $namespace_index = 'admin.service_provider.index';
        $namespace_update = 'admin.service_provider.update';
        $languages = Language::all();
        $categories = Category::where('type', 'service_provider')->get();
    ...
    {
        $namespace = 'admin.service_provider.index';
