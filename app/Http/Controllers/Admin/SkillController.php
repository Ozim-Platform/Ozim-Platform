...
class SkillController extends Controller
{
    ...
    public function index(){
        $namespace_create = 'admin.skill.create';
    ...
    public function create(){
        $namespace_index = 'admin.skill.index';
        $namespace_store = 'admin.skill.store';
        $languages = Language::all();
        $categories = Category::where('type', 'skill')->get();
    ...
    public function store(Request $request){
        ...
        $model->image = $request->has('image')
            ? MediaHelper::uploadFile($request->image, 'skills') : $model->image;
    ...
    public function edit($id){
        $namespace_index = 'admin.skill.index';
        $namespace_update = 'admin.skill.update';
        $languages = Language::all();
        $categories = Category::where('type', 'skill')->get();
