            ...
            <form action="{{ route($namespace_update, $item->_id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input id="phone" type="text" class="form-control" name="phone" value="{{ $item->phone ?? '7' }}" required placeholder="Телефон" data-mask="+0-000-000-00-00" data-mask-selectonfocus="false" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input  class="form-control" value="{{ $item->email }}" type="text" name="email">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input  class="form-control" value="{{ $item->link }}" type="text" name="link">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input value="{{ $item->tags }}" class="form-control" type="text" name="tags">
                        </div>
                    </div>
                    <div class="form-group row">
