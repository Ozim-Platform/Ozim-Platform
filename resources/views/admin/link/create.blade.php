            ...
            <form action="{{ route($namespace_store) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <i>https://</i><input class="form-control" type="text" name="link">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <h5 class="col-form-label col-md-2">Фото </h5>
                        <div class="controls col-form-label col-md-10">
                            <input type="file" name="image" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        <h5 class="col-form-label col-md-2">Обложка </h5>
                        <div class="controls col-form-label col-md-10">
                    ...
                    <div class="form-group row">
                        <h5 class="col-form-label col-md-2">Фото автора </h5>
                        <div class="controls col-form-label col-md-10">
